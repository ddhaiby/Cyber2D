[cyber2d](../README.md) / [Modules](../modules.md) / [UI/HealthBar](../modules/UI_HealthBar.md) / HealthBar
...
- [once](UI_HealthBar.HealthBar.md#once)
...
▸ **lineGradientStyle**(`lineWidth`, `topLeft`, `topRight`, `bottomLeft`, `bottomRight`, `alpha?`): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **restore**(): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **setRotation**(`radians?`): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **setScale**(`x`, `y?`): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **setScrollFactor**(`x`, `y?`): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **setState**(`value`): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **setVisible**(`value`): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **setW**(`value?`): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **setX**(`value?`): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **setY**(`value?`): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **setZ**(`value?`): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **slice**(`x`, `y`, `radius`, `startAngle`, `endAngle`, `anticlockwise?`, `overshoot?`): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **stroke**(): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **strokeCircle**(`x`, `y`, `radius`): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **strokeCircleShape**(`circle`): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **strokeEllipse**(`x`, `y`, `width`, `height`, `smoothness?`): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **strokeEllipseShape**(`ellipse`, `smoothness?`): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **strokeLineShape**(`line`): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **strokePath**(): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **strokePoints**(`points`, `closeShape?`, `closePath?`, `endIndex?`): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **strokeRect**(`x`, `y`, `width`, `height`): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **strokeRectShape**(`rect`): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **strokeRoundedRect**(`x`, `y`, `width`, `height`, `radius?`): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **strokeTriangle**(`x0`, `y0`, `x1`, `y1`, `x2`, `y2`): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **strokeTriangleShape**(`triangle`): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **toggleData**(`key`): [`HealthBar`](UI_HealthBar.HealthBar.md)
...
▸ **translateCanvas**(`x`, `y`): [`HealthBar`](UI_HealthBar.HealthBar.md)
