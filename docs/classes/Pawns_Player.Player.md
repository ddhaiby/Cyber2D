[cyber2d](../README.md) / [Modules](../modules.md) / [Pawns/Player](../modules/Pawns_Player.md) / Player
...
- [isLookingDown](Pawns_Player.Player.md#islookingdown)
...
- [jump](Pawns_Player.Player.md#jump)
...
- [setFrame](Pawns_Player.Player.md#setframe)
...
▸ **playReverse**(`key`, `ignoreIfPlaying?`): [`Player`](Pawns_Player.Player.md)
...
[src/Pawns/Player.ts:212](https://github.com/Pldu78/Cyber2D-1/blob/f2bef66/src/Pawns/Player.ts#L212)
...
[src/Pawns/Player.ts:317](https://github.com/Pldu78/Cyber2D-1/blob/f2bef66/src/Pawns/Player.ts#L317)
...
[src/Pawns/Player.ts:312](https://github.com/Pldu78/Cyber2D-1/blob/f2bef66/src/Pawns/Player.ts#L312)
...
[src/Pawns/Player.ts:392](https://github.com/Pldu78/Cyber2D-1/blob/f2bef66/src/Pawns/Player.ts#L392)
...
[src/Pawns/Player.ts:345](https://github.com/Pldu78/Cyber2D-1/blob/f2bef66/src/Pawns/Player.ts#L345)

___

### refreshBody

▸ **refreshBody**(): [`Player`](Pawns_Player.Player.md)
...
▸ **removeAllListeners**(`event?`): [`Player`](Pawns_Player.Player.md)
...
▸ **removeFromDisplayList**(): [`Player`](Pawns_Player.Player.md)
...
▸ **removeFromUpdateList**(): [`Player`](Pawns_Player.Player.md)
...
▸ **removeInteractive**(): [`Player`](Pawns_Player.Player.md)
...
▸ **removeListener**(`event`, `fn?`, `context?`, `once?`): [`Player`](Pawns_Player.Player.md)
...
▸ **removePostPipeline**(`pipeline`): [`Player`](Pawns_Player.Player.md)
...
[src/Pawns/Player.ts:187](https://github.com/Pldu78/Cyber2D-1/blob/f2bef66/src/Pawns/Player.ts#L187)

___

### resetFlip

▸ **resetFlip**(): [`Player`](Pawns_Player.Player.md)
...
▸ **setAcceleration**(`x`, `y?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setAccelerationX**(`value`): [`Player`](Pawns_Player.Player.md)
...
▸ **setAccelerationY**(`value`): [`Player`](Pawns_Player.Player.md)
...
▸ **setActive**(`value`): [`Player`](Pawns_Player.Player.md)
...
▸ **setAlpha**(`topLeft?`, `topRight?`, `bottomLeft?`, `bottomRight?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setAngle**(`degrees?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setAngularAcceleration**(`value`): [`Player`](Pawns_Player.Player.md)
...
▸ **setAngularDrag**(`value`): [`Player`](Pawns_Player.Player.md)
...
▸ **setAngularVelocity**(`value`): [`Player`](Pawns_Player.Player.md)
...
▸ **setBlendMode**(`value`): [`Player`](Pawns_Player.Player.md)
...
▸ **setBodySize**(`width`, `height`, `center?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setBounce**(`x`, `y?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setBounceX**(`value`): [`Player`](Pawns_Player.Player.md)
...
▸ **setBounceY**(`value`): [`Player`](Pawns_Player.Player.md)
...
▸ **setCircle**(`radius`, `offsetX?`, `offsetY?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setCollideWorldBounds**(`value?`, `bounceX?`, `bounceY?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setCrop**(`x?`, `y?`, `width?`, `height?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setDamping**(`value`): [`Player`](Pawns_Player.Player.md)
...
▸ **setData**(`key`, `data?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setDataEnabled**(): [`Player`](Pawns_Player.Player.md)
...
▸ **setDebug**(`showBody`, `showVelocity`, `bodyColor`): [`Player`](Pawns_Player.Player.md)
...
▸ **setDebugBodyColor**(`value`): [`Player`](Pawns_Player.Player.md)
...
▸ **setDepth**(`value`): [`Player`](Pawns_Player.Player.md)
...
▸ **setDisplayOrigin**(`x?`, `y?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setDisplaySize**(`width`, `height`): [`Player`](Pawns_Player.Player.md)
...
▸ **setDrag**(`x`, `y?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setDragX**(`value`): [`Player`](Pawns_Player.Player.md)
...
▸ **setDragY**(`value`): [`Player`](Pawns_Player.Player.md)
...
▸ **setFlip**(`x`, `y`): [`Player`](Pawns_Player.Player.md)
...
▸ **setFlipX**(`value`): [`Player`](Pawns_Player.Player.md)
...
▸ **setFlipY**(`value`): [`Player`](Pawns_Player.Player.md)
...
▸ **setFrame**(`frame`, `updateSize?`, `updateOrigin?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setFriction**(`x`, `y?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setFrictionX**(`x`): [`Player`](Pawns_Player.Player.md)
...
▸ **setFrictionY**(`y`): [`Player`](Pawns_Player.Player.md)
...
▸ **setGravity**(`x`, `y?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setGravityX**(`x`): [`Player`](Pawns_Player.Player.md)
...
▸ **setGravityY**(`y`): [`Player`](Pawns_Player.Player.md)
...
▸ **setImmovable**(`value?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setInteractive**(`hitArea?`, `callback?`, `dropZone?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setMask**(`mask`): [`Player`](Pawns_Player.Player.md)
...
▸ **setMass**(`value`): [`Player`](Pawns_Player.Player.md)
...
▸ **setMaxVelocity**(`x`, `y?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setName**(`value`): [`Player`](Pawns_Player.Player.md)
...
▸ **setOffset**(`x`, `y?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setOrigin**(`x?`, `y?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setOriginFromFrame**(): [`Player`](Pawns_Player.Player.md)
...
▸ **setPipeline**(`pipeline`, `pipelineData?`, `copyData?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setPipelineData**(`key`, `value?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setPosition**(`x?`, `y?`, `z?`, `w?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setPostPipeline**(`pipelines`, `pipelineData?`, `copyData?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setPushable**(`value?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setRandomPosition**(`x?`, `y?`, `width?`, `height?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setRotation**(`radians?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setScale**(`x`, `y?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setScrollFactor**(`x`, `y?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setSize**(`width`, `height`): [`Player`](Pawns_Player.Player.md)
...
▸ **setSizeToFrame**(`frame`): [`Player`](Pawns_Player.Player.md)
...
▸ **setState**(`value`): [`Player`](Pawns_Player.Player.md)
...
▸ **setTexture**(`key`, `frame?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setTint**(`topLeft?`, `topRight?`, `bottomLeft?`, `bottomRight?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setTintFill**(`topLeft?`, `topRight?`, `bottomLeft?`, `bottomRight?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setVelocity**(`x`, `y?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setVelocityX**(`x`): [`Player`](Pawns_Player.Player.md)
...
▸ **setVelocityY**(`y`): [`Player`](Pawns_Player.Player.md)
...
▸ **setVisible**(`value`): [`Player`](Pawns_Player.Player.md)
...
▸ **setW**(`value?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setX**(`value?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setY**(`value?`): [`Player`](Pawns_Player.Player.md)
...
▸ **setZ**(`value?`): [`Player`](Pawns_Player.Player.md)
...
▸ **stop**(): [`Player`](Pawns_Player.Player.md)
...
▸ **stopAfterDelay**(`delay`): [`Player`](Pawns_Player.Player.md)
...
▸ **stopAfterRepeat**(`repeatCount?`): [`Player`](Pawns_Player.Player.md)
...
▸ **stopOnFrame**(`frame`): [`Player`](Pawns_Player.Player.md)
...
[src/Pawns/Player.ts:401](https://github.com/Pldu78/Cyber2D-1/blob/f2bef66/src/Pawns/Player.ts#L401)
...
[src/Pawns/Player.ts:373](https://github.com/Pldu78/Cyber2D-1/blob/f2bef66/src/Pawns/Player.ts#L373)
...
▸ **toggleData**(`key`): [`Player`](Pawns_Player.Player.md)
...
▸ **toggleFlipX**(): [`Player`](Pawns_Player.Player.md)
...
▸ **toggleFlipY**(): [`Player`](Pawns_Player.Player.md)
...
[src/Pawns/Player.ts:196](https://github.com/Pldu78/Cyber2D-1/blob/f2bef66/src/Pawns/Player.ts#L196)
...
[src/Pawns/Player.ts:252](https://github.com/Pldu78/Cyber2D-1/blob/f2bef66/src/Pawns/Player.ts#L252)
...
[src/Pawns/Player.ts:220](https://github.com/Pldu78/Cyber2D-1/blob/f2bef66/src/Pawns/Player.ts#L220)

___

### updateDisplayOrigin

▸ **updateDisplayOrigin**(): [`Player`](Pawns_Player.Player.md)
...
▸ `Private` **updateSparkles**(`health`, `maxHealth`): `void`
...
[src/Pawns/Player.ts:290](https://github.com/Pldu78/Cyber2D-1/blob/f2bef66/src/Pawns/Player.ts#L290)
