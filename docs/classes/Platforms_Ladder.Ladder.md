[cyber2d](../README.md) / [Modules](../modules.md) / [Platforms/Ladder](../modules/Platforms_Ladder.md) / Ladder
...
- [rotation](Platforms_Ladder.Ladder.md#rotation)
...
- [listeners](Platforms_Ladder.Ladder.md#listeners)
...
- [setPipeline](Platforms_Ladder.Ladder.md#setpipeline)
...
▸ **setActive**(`value`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setDrag**(`x`, `y?`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setMass**(`value`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setMaxVelocity**(`x`, `y?`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setName**(`value`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setOffset**(`x`, `y?`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setOrigin**(`x?`, `y?`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setOriginFromFrame**(): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setPipeline**(`pipeline`, `pipelineData?`, `copyData?`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setPipelineData**(`key`, `value?`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setPosition**(`x?`, `y?`, `z?`, `w?`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setPostPipeline**(`pipelines`, `pipelineData?`, `copyData?`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setPushable**(`value?`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setRandomPosition**(`x?`, `y?`, `width?`, `height?`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setRotation**(`radians?`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setScale**(`x`, `y?`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setScrollFactor**(`x`, `y?`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setSize**(`width`, `height`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setSizeToFrame**(`frame`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setState**(`value`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setTexture**(`key`, `frame?`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setTint**(`topLeft?`, `topRight?`, `bottomLeft?`, `bottomRight?`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setTintFill**(`topLeft?`, `topRight?`, `bottomLeft?`, `bottomRight?`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setVelocity**(`x`, `y?`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setVelocityX**(`x`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setVelocityY**(`y`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setVisible**(`value`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setW**(`value?`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setX**(`value?`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setY**(`value?`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **setZ**(`value?`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **toggleData**(`key`): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **toggleFlipX**(): [`Ladder`](Platforms_Ladder.Ladder.md)
...
▸ **toggleFlipY**(): [`Ladder`](Platforms_Ladder.Ladder.md)
...
[src/Platforms/Ladder.ts:27](https://github.com/Pldu78/Cyber2D-1/blob/f2bef66/src/Platforms/Ladder.ts#L27)

___

### updateDisplayOrigin

▸ **updateDisplayOrigin**(): [`Ladder`](Platforms_Ladder.Ladder.md)
...
### updatePawnInteraction

▸ **updatePawnInteraction**(): `void`
...
[src/Platforms/Ladder.ts:38](https://github.com/Pldu78/Cyber2D-1/blob/f2bef66/src/Platforms/Ladder.ts#L38)
