[cyber2d](../README.md) / [Modules](../modules.md) / [Platforms/Mine](../modules/Platforms_Mine.md) / Mine
...
- [pipelineData](Platforms_Mine.Mine.md#pipelinedata)
...
- [getLocalPoint](Platforms_Mine.Mine.md#getlocalpoint)
...
- [setFlip](Platforms_Mine.Mine.md#setflip)
...
[src/Platforms/Mine.ts:107](https://github.com/Pldu78/Cyber2D-1/blob/f2bef66/src/Platforms/Mine.ts#L107)
...
▸ **setDragY**(`value`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setFlip**(`x`, `y`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setFlipX**(`value`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setFlipY**(`value`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setFrame**(`frame`, `updateSize?`, `updateOrigin?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setFriction**(`x`, `y?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setFrictionX**(`x`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setFrictionY**(`y`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setGravity**(`x`, `y?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setGravityX**(`x`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setGravityY**(`y`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setImmovable**(`value?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setInteractive**(`hitArea?`, `callback?`, `dropZone?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setMask**(`mask`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setMass**(`value`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setMaxVelocity**(`x`, `y?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setName**(`value`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setOffset**(`x`, `y?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setOrigin**(`x?`, `y?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setOriginFromFrame**(): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setPipeline**(`pipeline`, `pipelineData?`, `copyData?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setPipelineData**(`key`, `value?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setPosition**(`x?`, `y?`, `z?`, `w?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setPostPipeline**(`pipelines`, `pipelineData?`, `copyData?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setPushable**(`value?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setRandomPosition**(`x?`, `y?`, `width?`, `height?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setRotation**(`radians?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setScale**(`x`, `y?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setScrollFactor**(`x`, `y?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setSize**(`width`, `height`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setSizeToFrame**(`frame`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setState**(`value`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setTexture**(`key`, `frame?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setTint**(`topLeft?`, `topRight?`, `bottomLeft?`, `bottomRight?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setTintFill**(`topLeft?`, `topRight?`, `bottomLeft?`, `bottomRight?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setVelocity**(`x`, `y?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setVelocityX**(`x`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setVelocityY**(`y`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setVisible**(`value`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setW**(`value?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setX**(`value?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setY**(`value?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **setZ**(`value?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **stop**(): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **stopAfterDelay**(`delay`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **stopAfterRepeat**(`repeatCount?`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **stopOnFrame**(`frame`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **toggleData**(`key`): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **toggleFlipX**(): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **toggleFlipY**(): [`Mine`](Platforms_Mine.Mine.md)
...
▸ **updateDisplayOrigin**(): [`Mine`](Platforms_Mine.Mine.md)
