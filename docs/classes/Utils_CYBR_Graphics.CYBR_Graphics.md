[cyber2d](../README.md) / [Modules](../modules.md) / [Utils/CYBR\_Graphics](../modules/Utils_CYBR_Graphics.md) / CYBR\_Graphics
...
- [w](Utils_CYBR_Graphics.CYBR_Graphics.md#w)
...
- [preDestroy](Utils_CYBR_Graphics.CYBR_Graphics.md#predestroy)
...
Phaser.GameObjects.Graphics.defaultPipeline
...
Phaser.GameObjects.Graphics.postPipelines
...
Phaser.GameObjects.Graphics.scene
...
Phaser.GameObjects.Graphics.fillPoint
...
▸ **setPostPipeline**(`pipelines`, `pipelineData?`, `copyData?`): [`CYBR_Graphics`](Utils_CYBR_Graphics.CYBR_Graphics.md)
...
Phaser.GameObjects.Graphics.setScrollFactor
...
Phaser.GameObjects.Graphics.setX
...
Phaser.GameObjects.Graphics.strokePoints
...
▸ **strokeRect**(`x`, `y`, `width`, `height`): [`CYBR_Graphics`](Utils_CYBR_Graphics.CYBR_Graphics.md)
...
Phaser.GameObjects.Graphics.strokeRect
...
▸ **strokeRectShape**(`rect`): [`CYBR_Graphics`](Utils_CYBR_Graphics.CYBR_Graphics.md)
...
Phaser.GameObjects.Graphics.strokeRectShape
...
▸ **strokeRoundedRect**(`x`, `y`, `width`, `height`, `radius?`): [`CYBR_Graphics`](Utils_CYBR_Graphics.CYBR_Graphics.md)
...
Phaser.GameObjects.Graphics.strokeRoundedRect
...
▸ **strokeTriangle**(`x0`, `y0`, `x1`, `y1`, `x2`, `y2`): [`CYBR_Graphics`](Utils_CYBR_Graphics.CYBR_Graphics.md)
...
Phaser.GameObjects.Graphics.strokeTriangle
...
▸ **strokeTriangleShape**(`triangle`): [`CYBR_Graphics`](Utils_CYBR_Graphics.CYBR_Graphics.md)
...
Phaser.GameObjects.Graphics.strokeTriangleShape
...
Phaser.GameObjects.Graphics.toJSON
...
▸ **toggleData**(`key`): [`CYBR_Graphics`](Utils_CYBR_Graphics.CYBR_Graphics.md)
...
Phaser.GameObjects.Graphics.toggleData
...
▸ **translateCanvas**(`x`, `y`): [`CYBR_Graphics`](Utils_CYBR_Graphics.CYBR_Graphics.md)
...
Phaser.GameObjects.Graphics.translateCanvas
...
Phaser.GameObjects.Graphics.update
...
Phaser.GameObjects.Graphics.willRender
