...
If you are not familiar with git, I suggest you to install _TortoiseGit_ which is a convenient software to use. In the next step, I will use this software to show you how to save and send your updates of the project.
